...
# sidekiq worker to create reports about general order information
class ReportWorker
  ...
  def data_of_VM_with_maximum_number_of_dop_disks
    ...
    "ВМ у которых подключено больше всего дополнительных дисков (по количеству): #{sorted_dop_counts.reverse.first(10)}"
  end
